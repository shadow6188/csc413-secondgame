...
public class TankControl implements KeyListener {
    ...
    private final int switchright;
    
    public TankControl(Tank tank, int up, int down, int left, int right, int shoot, int switchRight) {
        this.tank = tank;
        this.up = up;
        this.down = down;
        this.right = right;
    ...
    public void keyPressed(KeyEvent ke) {
        ...
        if (keyPressed == switchright){
            this.tank.toggleSwitchRightPressed();
        }
    }
    ...
    public void keyReleased(KeyEvent ke) {
        ...
        if (keyReleased == switchright){
            this.tank.untoggleSwitchRightPressed();
        }
    }
}
